...
export const testHistory = [{ version: "p2", digest: SUPPORTED_POLICY_TUPLES[0]!.expectedDigest, schemaVersion: 1, releaseCommit: "test-only", productApprovalRef: "test-only-product", securityApprovalRef: "test-only-security" }];
