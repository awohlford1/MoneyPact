...
const INFRASTRUCTURE_MESSAGE =
  "CBD-111 is an idle worker skeleton only. Queue, database, scheduler, provider, " +
  "and cloud SDK dependencies arrive in their owning stories.";
        ...
        "error",
        {
          patterns: [
            ...
            },
            {
              group: ["**/api/**"],
              message:
                "Applications are separate deployment units. Share contracts through a workspace package.",
            },
          ],
        },
      ],
