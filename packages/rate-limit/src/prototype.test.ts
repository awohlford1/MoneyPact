...
// projected create, resend, cancel, inspect and local-delivery records), plus rlp-266-protected-action-v1 on
// surf-266-protected-action (PK-7B: the six Primary-transfer routes; proto-mutation-v1 values).
const APPROVED_RECORDS = 14;
