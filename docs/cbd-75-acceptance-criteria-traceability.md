...
| `docs/cbd-73-invitation-consent-lifecycle-specification.md` and its message inventory | v1.0.5 | §2 cross-cutting semantic rules, generalized into `CS-75-01`–`CS-75-12`; the surfaces `PT-75-01`–`PT-75-05` shape |
