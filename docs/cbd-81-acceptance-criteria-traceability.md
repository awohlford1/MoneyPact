...
8. Resolve DEF-81-002 against approved CBD-77/CBD-80 corrections. Exercise
   ...
   Include periodless manual-account spaces: two such spaces and one period-bearing space must expose the unresolved MT-77-006 population mismatch, not produce a credited 200% activation rate. Do not globally narrow shared MS-80-004 to repair another metric.
   Confirm MT-77-001/002/003/006 receive no computation or baseline credit while
