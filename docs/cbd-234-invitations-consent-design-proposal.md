...
| Governing lifecycle | `docs/cbd-73-invitation-consent-lifecycle-specification.md` v1.0.3 — §3 invariants, §4 states and `TR-73-*`, §5 and §5.1, §6 rules 1–6, §7.2, §12 transfer, §13 `DR-73-*`, §14 `AE-73-*`, §15 `OI-73-*` |
