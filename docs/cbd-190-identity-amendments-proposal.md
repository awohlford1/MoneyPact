...
| Field | Value |
| --- | --- |
| Status | **Proposed.** Not yet applied to `docs/cbd-190-identity-ceremony-and-mapping-contract.md`; the Product Owner and Security must approve before an implementation packet is cut |
...
| Governing contract | `docs/cbd-190-identity-ceremony-and-mapping-contract.md` \| Document version **0.4** — §3 (environment configuration, `post_result_destination_id`), §4.1 (begin command), §4.4 (step-up begin), §5.2 (mapping transaction step 3), §7 (deterministic safe outcomes), §10.2 (credential-material inventory) |
