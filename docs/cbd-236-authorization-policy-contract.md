...
| Field | Value |
| --- | --- |
| Status | **Proposed v0.4 — corrected Architecture proposal; repeat Security, Product, and independent review required before the implementation packet.** This document decides the policy contract and its placement. It ships no code, redefines no CBD-72 permission, and closes no CBD-94 gate |
