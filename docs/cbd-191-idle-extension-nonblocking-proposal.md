...
| Governing contract | `docs/cbd-191-session-and-revocation-contract.md` \| Document version **0.4** (0.3.1 at the time this proposal was written; amendment `SC-191-006` applied by `PROTO-CBD191-IDLE-IMPL-001`) — §3.3 (resolution, case 5), §4 (`SC-191-002`, the authority row lock), §5.1 (the idle slide sentence and, as of 0.4, `SC-191-006`), §8 (`CT-191-009`, `CT-191-010`, `CT-191-013`, `CT-191-018`), §12, §13 |
