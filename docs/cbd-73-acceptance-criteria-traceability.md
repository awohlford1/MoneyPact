...
| `docs/cbd-72-collaboration-permission-model.md` | Document version **0.1.54**; approved August 18, 2026 at v0.1.53, §5.4 amended September 2, 2026 | `ffd3deb4d4fe0999cffc9c3d1389b75d90eafffc` | Roles, permissions 24–29, one-role/one-Primary invariants, protected actions, transfer, revocation, ownership exits, attribution and audit schema. Re-pinned September 15, 2026 for the proposed row 36 (manual-account management, PO-CBD72-ROW36-001), which adds a permission row CBD-73 does not cite; previously re-pinned for the v0.1.54 §5.4 amendment removing the recipient-configurable "privacy" item; CBD-73 cites §5.4 only for the personal-settings boundary, which neither amendment changes, so no CBD-73 rule is affected |
