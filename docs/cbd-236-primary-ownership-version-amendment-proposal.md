...
| Governing contract | `docs/cbd-236-authorization-policy-contract.md` \| Document version **0.13** (v0.13 is this proposal's `POV-R01`–`POV-R08` applied; §1–§10 were written against v0.12.2) — §4.1, §4.2, §6 `PC-236-011`, `PC-236-013`, `PC-236-014`, `PC-236-015`, §6.1, §8.5.3, §9.3, §9.7, §12, §14 |
